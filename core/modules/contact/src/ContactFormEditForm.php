...
class ContactFormEditForm extends EntityForm implements ContainerInjectionInterface {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['weight'] = [
      ...
      '#description' => $this->t('When listing forms, those with lighter (smaller) weights get listed before forms with heavier (larger) weights. Form with equal weights are sorted alphabetically.'),
    ];
    $form['selected'] = [
      '#type' => 'checkbox',
