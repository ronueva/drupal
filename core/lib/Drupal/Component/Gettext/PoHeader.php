...
class PoHeader {
  ...
  public function setFromString($header) {
    ...
    if (!empty($values['Plural-Form'])) {
      $this->_pluralForms = $values['Plural-Form'];
    }
  }
  ...
  public function __toString() {
    ...
    $output .= "\"Plural-Form: " . $this->_pluralForms . "\\n\"\n";
    $output .= "\n";
  ...
  /**
   * Parses a Plural-Form entry from a Gettext Portable Object file header.
   *
   * @param string $pluralforms
   *   The Plural-Form entry value.
   *
   * @return
